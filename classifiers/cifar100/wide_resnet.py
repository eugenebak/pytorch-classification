...
def _wrnet(arch, depth, widen_factor, dropout_rate=0.3, num_classes=10, device="cpu", pretrained=True, **kwargs):
    ...
    if pretrained:
        ...
        state_dict = torch.load("../pretrained/classifiers/cifar100/" + arch + ".pth" )
...
def wrnet_28_10(pretrained=True, device="cpu", **kwargs):
    return _wrnet("wrnet-28-10", 28, 10, 0.3, 100, device, pretrained, **kwargs)

def wrnet_34_10(pretrained=True, device="cpu", **kwargs):
    return _wrnet("wrnet-34-10", 34, 10, 0.3, 100, device, pretrained, **kwargs)

def wrnet_70_16(pretrained=True, device="cpu", **kwargs):
    return _wrnet("wrnet-70-16", 70, 16, 0.3, 100, device, pretrained, **kwargs)
